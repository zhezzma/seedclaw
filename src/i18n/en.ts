export default {
    ...
    extensions: {
        ...
        tunnel: {
            label: 'Mobile Tunnel',
            idle: 'Not connected (connect auto-configures the VPS and establishes the tunnel)',
            starting: 'Initializing and connecting...',
            stopping: 'Disconnecting...',
            connecting: 'Establishing SSH tunnel...',
            ready: 'Tunnel ready. Scan the QR code from your phone',
            ...
            lanReady: 'LAN direct access ready (phone on the same network as the PC; no VPS needed)',
            lanNoIp: 'No LAN address detected (check network connection)',
            lanSwitchHint: 'Need access from outside? Switch the mode to "Remote tunnel" in extension settings',
