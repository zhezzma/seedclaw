export default {
    ...
    workspaceBinding: {
        ...
        boundSingle: 'Already bound to agent {name}; switch after confirming',
        boundMultiple: 'This directory is already bound to:',
        hasPi: 'This directory contains .pi project configuration',
        ...
        next: 'Next',
        createTitle: 'Bind project folder',
        createDesc: 'A new agent bound to this directory will be created',
