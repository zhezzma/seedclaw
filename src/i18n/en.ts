export default {
    ...
    chat: {
        ...
        treeUserNode: 'User Message',
        treeAssistantNode: 'Assistant Reply',
        treeMessageNode: 'Message Node',
        treeSummaryNode: 'Branch Summary',
        treeSessionInfoNode: 'Session Info',
        treeModelNode: 'Model Change',
        treeThinkingNode: 'Thinking Setting',
        treeCurrent: 'Current',
        treeViewOnly: 'Read-only',
