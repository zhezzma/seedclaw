export default {
    ...
    sidebar: {
        ...
        pin: 'Pin',
        unpin: 'Unpin',
        localServerNotReady: 'Local server is not ready. Try again later or check Settings',
        remoteNotConfigured: 'Remote server URL is not configured. Set it in Settings → Gateway',
        more: 'More',
        rename: 'Rename',
        viewInfo: 'View Info',
        sessionInfo: {
    ...
    agent: {
        ...
        retryMaxAgentDelayMs: 'Retry Backoff Cap ms (maxAgentDelayMs, default 60000)',
        retryProviderSection: 'Provider-Level Request Settings (retry.provider)',
        retryProviderTimeoutMs: 'Request Timeout ms (provider.timeoutMs, empty = global)',
        retryProviderMaxRetries: 'Provider Max Retries (provider.maxRetries, empty = global)',
        retryProviderMaxRetryDelayMs: 'Provider Retry Delay Cap (provider.maxRetryDelayMs, default 60000)',
        retryProviderUnsetHint: 'Empty = unset',
        cacheWarming: 'Cache Warming',
        cacheWarmingDesc: 'Sends warming requests while streaming/idle to keep the prompt cache warm, reducing cold-start cost but making extra calls. Defaults to streaming when unset.',
        cacheWarmingOff: 'Off (off)',
        cacheWarmingStreaming: 'While streaming (streaming, default)',
        cacheWarmingIdle: 'Also while idle (idle)',
        thinkingBudgets: 'Thinking Budgets',
        thinkingBudgetsDesc: 'Set thinking token budgets per thinking level (only applies to models that support budgets, e.g. Anthropic). Empty = model default.',
        thinkingBudgetMinimal: 'Minimal budget (minimal)',
        thinkingBudgetLow: 'Low budget (low)',
        thinkingBudgetMedium: 'Medium budget (medium)',
        thinkingBudgetHigh: 'High budget (high)',
        thinkingBudgetUnsetHint: 'Empty = unset',
        ...
        subagents: {
            ...
            // Extension source: custom = own whitelist; config = follows global "Subagent Default Extensions"
            extensionsModeCustom: 'Custom Selection',
            extensionsModeConfig: 'Use Configured Extensions',
            extensionsModeConfigHint: 'Mounts the extensions checked in the global "Subagent Default Extensions" setting; follows global config changes automatically.',
            extensionsModeConfigBadge: 'Follows Global Extension Config',
    ...
    workspaceBinding: {
        fieldLabel: 'Workspace directory (server path)',
        browse: 'Browse…',
        placeholder: 'Absolute project path on the server, e.g. /srv/apps/demo',
        okGit: 'Valid directory (git repository)',
        okPlain: 'Valid directory',
        errNotExists: 'Path does not exist on the server',
        errNotDir: 'Path is not a directory',
        errForbidden: 'Binding inside the server data directory is forbidden',
        errInvalid: 'Invalid path',
        errNetwork: 'Cannot reach the server',
        boundSingle: 'This directory is already bound to agent {name}',
    ...
    cron: {
        ...
        errorMainSession: 'Main session plans require "System Event" payload.',
        errorIsolatedSession: 'Isolated session plans require "Agent Turn" payload.',
        units: {
            minutes: 'Minutes',
            hours: 'Hours',
            days: 'Days',
    ...
    delivery: {
        ...
        description: 'When a plan or heartbeat finishes, its result is delivered to these targets.',
    ...
    provider: {
        ...
        compat: {
            ...
            requiresReasoningContentOnAssistantMessages: 'Replay assistant needs reasoning_content',
            zaiToolStream: 'Z.AI tool_stream',
            cacheControlFormat: 'cache_control format',
            ...
            sendSessionIdHeader: 'Send session_id header',
    ...
    model: {
        ...
        thinking: {
            ...
            hint: 'Map pi thinking levels to provider values. Default = omit (use provider default); Custom = send the value you enter; Disabled = unsupported. To enable xhigh/max, choose Custom and enter a value (e.g. xhigh, max).',
            modeDefault: 'Default',
            modeCustom: 'Custom',
            modeDisabled: 'Disabled',
            valuePlaceholder: 'value',
            xhighPlaceholder: 'e.g. xhigh/max',
        },
    },
    chat: {
        you: 'You',
    ...
    extensions: {
        title: 'Extensions',
        newSessionHint: 'Extension toggles only apply to new sessions; mounted extension APIs are unaffected.',
        ...
        panel: 'Panel',
        panelTitle: '{name} Panel',
        unknownPanelType: 'Unknown panel type: {type}',
        qrLogin: {
            label: 'Login',
            qrAlt: 'Login QR code',
            idle: 'Preparing QR code...',
            starting: 'Loading QR code...',
            waiting: 'Scan the QR code to log in',
            success: 'Login successful',
            expired: 'QR code expired. Reopen the panel to retry.',
            failed: 'Login failed. Please try again later.',
        },
        tunnel: {
            label: 'Mobile Tunnel',
            idle: 'Remote tunnel not connected (connect auto-configures the VPS and establishes the tunnel)',
            starting: 'Initializing and connecting...',
            stopping: 'Disconnecting...',
            connecting: 'Establishing SSH tunnel...',
            ready: 'Remote tunnel ready (accessible from the internet)',
            failed: 'Remote tunnel connection failed',
            reconnecting: 'Auto-reconnecting (attempt {n})...',
            start: 'Connect',
            stop: 'Disconnect',
            startHint: 'Disconnecting releases the VPS port; connecting re-runs provisioning automatically (skips when already configured)',
            qrAlt: 'Mobile access QR code',
            copyUrl: 'Copy link',
            hint: 'Scan with your phone or open the link in a browser; the access token is configured automatically on first open',
    ...
    gateway: {
        noGateway: 'No server connected',
        switchAccount: 'Switch server account',
        current: 'Active',
    ...
    settings: {
        ...
        language: 'Language',
        sessionTreeRail: 'Session Tree Rail',
        sessionTreeRailDesc: 'Message quick-jump rail on the left of the chat page (desktop only)',
        dark: 'Dark',
        light: 'Light',
    ...
    setup: {
        ...
        localServerStarting: 'Starting',
        localServerRunning: 'Ready',
        localServerFailed: 'Failed to start',
        localServerRetry: 'Retry',
        useRemoteServer: 'Connect to a remote server',
