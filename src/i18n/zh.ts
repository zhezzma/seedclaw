export default {
    ...
    sidebar: {
        ...
        pin: '置顶',
        unpin: '取消置顶',
        gatewayTipLocal: '当前：本地服务 · 点击切换到远程服务器',
        gatewayTipRemote: '当前：远程服务器 · 点击切换到本地服务',
    ...
    extensions: {
        ...
        tunnel: {
            label: '移动端隧道',
            idle: '未连接（连接时自动配置 VPS 并建立隧道）',
            starting: '正在初始化并连接...',
            stopping: '正在断开...',
            connecting: '正在建立 SSH 隧道...',
            ready: '隧道已就绪，手机扫码即可访问',
            failed: '隧道连接失败',
            ...
            tokenLabel: '令牌',
            appConnectHint: '手机 App → 设置 → 网关模式选「远程服务器」，填入上面的 URL 和令牌',
            lanReady: '局域网直连已就绪（手机与 PC 连同一网络即可访问，无需 VPS）',
            lanNoIp: '未检测到局域网地址（请检查网络连接）',
            lanSwitchHint: '需要外网访问？到扩展设置把模式切换为「远程隧道」',
            lanFirewallHint: '手机打不开时：检查 Windows 防火墙是否放行了本应用/端口',
            tokenMissing: '服务端未配置访问令牌，无法生成分享链接',
            verifyFailed: '⚠ 公网探测失败：手机现在访问不了这个地址。\n检查两件事：① 华为云控制台安全组是否放行了公网端口（默认 18799）；② VPS 是否已用面板「初始化并连接」完成配置（GatewayPorts）。',
        },
    },
    settings: {
        title: '设置',
